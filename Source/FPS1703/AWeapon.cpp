...
{
	int32 random_number = FMath::RandRange(1, 6);

	USoundBase* current_sound = 0;

	switch (random_number)
	{
	case 1:
		current_sound = Fire_Sound_1;
		break;
	case 2:
		current_sound = Fire_Sound_2;
		break;
	case 3:
		current_sound = Fire_Sound_3;
		break;
	case 4:
		current_sound = Fire_Sound_4;
		break;
	case 5:
		current_sound = Fire_Sound_5;
		break;
	case 6:
		current_sound = Fire_Sound_6;
		break;
	default:
		current_sound = 0;
		break;
	...
	if (current_sound)
	{
		UGameplayStatics::PlaySoundAtLocation(this, current_sound, Character->GetActorLocation());
	}
}
//-------------------------------------------------------------------------------------------------------
...
void AWeapon::MakeShot()
{
	...
	GetWorld()->LineTraceSingleByChannel(HitResult, trace_start, trace_end, ECollisionChannel::ECC_Visibility);
